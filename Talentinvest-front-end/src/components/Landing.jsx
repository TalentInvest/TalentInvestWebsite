    ...
    <Box>
      ...
      <Box fontSize={28} fontWeight="bold" length={70} width={600} margin={10}>
        ...
        <Box
          ...
          width={450}
        >
          Affordable access to higher education remains the foundation for a
          more sustainable future. At Talent Invest we want to be part of the
          revolution necessary to drive this goal.
        </Box>
        <Button style={{ background: "#b39ddb" }} variant="contained">
          <Box color="white">Start a New Profile Today</Box>
        </Button>
      </Box>
      ...
      >
        ...
        students attend the education of their dreams and give them the ability
        to defer payments until they land a secure job. We provide investors
        with the opportunity to make impactful decisions by directly supporting
        the next generation of talent, all while simultaneously earning a return
        on their investment
      </Box>
